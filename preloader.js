...
function initPreloader(){
		...
		$('.outContent').click(function(e) {
		    e.preventDefault();
		    var _this = this;			
  			$('#preloader').fadeIn(1500, function(){
